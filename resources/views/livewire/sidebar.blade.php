<div>
        <div @click.away="open = false" class="flex flex-col w-full md:w-64 text-gray-700 bg-white md:h-screen dark-mode:text-gray-200 dark-mode:bg-gray-800 flex-shrink-0" x-data="{ open: false }">
