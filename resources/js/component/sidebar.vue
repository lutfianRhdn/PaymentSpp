                    ...
                    <div>
                        <div class=" mb-5 mt-10 ">
                            <inertia-link :href="route('dashboard')" >
                                <div class="rounded-lg px-4 py-2 mb-2 hover:bg-gray-200 hover:shadow" :class="{'border-l border-green-500 border-l-4 ' : activeTab == 'class'}">
                            ...
                            <dropdown-component widthClass="w-full" v-if="$page.props.auth.can['user.index']"> 
                                <template #trigger>
                                    <div class="rounded-lg px-4 py-2 mb-2  hover:bg-gray-200 hover:shadow"     :class="{'active': $inertia.page.url.startsWith(href)}">
                                        <h1 class="text-lg"><i class="fas fa-users-cog text-2xl mr-5"></i> User Management</h1>
                                    </div>
                                </template>
                                <template #content >
                                    <div class="ml-5 -mt-5">
                                        <div class="rounded-lg px-4 py-2 mb-2  hover:bg-gray-200 hover:shadow">
                            ...
                            <inertia-link :href="route('classes.index')" v-if="$page.props.auth.can['class.index']">
                                <div class="rounded-lg px-4 py-2  mb-2 hover:bg-gray-200 hover:shadow" :class="{'booder-l border-green-500 border-l-4 ' : activeTab == 'class'}">
